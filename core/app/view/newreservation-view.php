...
<option value="">-- SELECCIONE --</option>
  ...
  <div class="form-group">
    ...
    <label for="inputEmail2" class="col-lg-1 control-label">Hora inicio</label>
    <div class="col-lg-2">
      <input type="time" name="time_at" required class="form-control" id="inputEmail2" placeholder="Hora">
    </div>
    <label for="inputEmail3" class="col-lg-1 control-label">Hora final</label>
    <div class="col-lg-2">
      <input type="time" name="end_time" required class="form-control" id="inputEmail3" placeholder="Hora">
    </div>
  </div>
  <div class="form-group">
